...
public class ContainerBarrel extends Container
{
	...
	public ContainerBarrel(IInventory playerInventory, IInventory BarrelInventory)
	{
		...
		BarrelInventory.openInventory(null);

		for (int i = 0; i < 3; i++)
		{
			for (int j = 0; j < 3; j++)
			{
				this.addSlotToContainer(new Slot(BarrelInventory, j + i * 3, 8 + j * 18 + 54, 18 + i * 18));
			}
		}
	...
	{
		return this.BarrelInventory.isUseableByPlayer(entityPlayer);
	}
	...
	public void onContainerClosed(EntityPlayer entityPlayer)
	{
		...
		this.BarrelInventory.closeInventory(entityPlayer);
	}
}
