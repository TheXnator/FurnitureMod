package thexnator.furnituremod.util.utilobjects.vectors.physics.real;
...
//		if(result!=null)result=result.mul();
	...
	public static Vec3 getNormal(Vec3 pos0,Vec3 pos1, Vec3 pos2){
		Vec3 vec3  = pos1.subtractReverse(pos0);
		Vec3 vec31 = pos1.subtractReverse(pos2);
		return vec31.crossProduct(vec3).normalize();
	}
