...
public class BlockSofa extends BlockFurniture {
	
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

	public BlockSofa(Material materialIn) {
		super(materialIn);
		setHardness(1.0F);
	...
	public void addCollisionBoxesToList(World world, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity)
	{
		if (!(collidingEntity instanceof EntitySittableBlock))
		{
			...
			float[] data = CollisionHelper.fixRotation(metadata, 0.825F, 0.1F, 1.0F, 1.0F);
	...
	{
		if (this == FurnitureBlocks.sofa_block)
			return FurnitureBlocks.sofa_block;
		return null;
	}
